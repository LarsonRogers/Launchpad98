...
# STOP TRACK button and its listener
    ...
    def _update_OSD(self):
        if self._osd != None:
            if self._is_pro_mode_on():
                mode_id = "pro_session"
                mode_label = "Pro Session"
                if self._record_pressed:
                    mode_id = "pro_session_arm"
                    mode_label = "Pro Session - Arm"
                elif self._duplicate_pressed:
                    mode_id = "pro_session_solo"
                    mode_label = "Pro Session - Solo"
                elif self._delete_pressed:
                    mode_id = "pro_session_mute"
                    mode_label = "Pro Session - Mute"
                elif self._double_pressed:
                    mode_id = "pro_session_fixed_length"
                    mode_label = "Pro Session - Fixed Length"
                elif self._quantize_pressed:
                    mode_id = "pro_session_record_quant"
                    mode_label = "Pro Session - Record Quant"
                elif self._click_pressed:
                    mode_id = "pro_session_metronome"
                    mode_label = "Pro Session - Metronome"
                elif self._shift_pressed:
                    mode_id = "pro_session_launch_quant"
                    mode_label = "Pro Session - Launch Quant"
            else:
                mode_id = "session"
                mode_label = "Session"

            self._osd.mode = mode_label
            self._osd.mode_id = mode_id
