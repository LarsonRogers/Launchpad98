...
This folder is the drop-in overlay for Launchpad95. Copy its contents into your existing `Launchpad95` Remote Scripts folder and overwrite when prompted.

**Install Launchpad95 (base)**
1. Download and unzip Launchpad95 from:
```
...
1. Copy the contents of this `Launchpad98` folder on top of your existing `Launchpad95` folder.
